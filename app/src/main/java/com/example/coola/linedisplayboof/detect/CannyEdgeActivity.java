package com.example.coola.linedisplayboof.detect;
...
import com.example.coola.linedisplayboof.DemoCamera2Activity;

import com.example.coola.linedisplayboof.DemoProcessingAbstract;
import com.example.coola.linedisplayboof.R;
	...
	implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener
{
	...
	public CannyEdgeActivity() {
		...
		super.bitmapMode = VisualizeCamera2Activity.BitmapMode.UNSAFE;
